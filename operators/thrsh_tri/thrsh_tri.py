...
@LICENSE
#
#  thrsh_tri.py Copyright (C) 2010-2026 Scott L. Williams.
# 
...
thrsh_tri_copyright = 'thrsh_tri.py Copyright (c) 2010-2026 Scott L. Williams, released under GNU GPL V3.0'
