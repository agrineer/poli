...
thrsh_li_copyright = 'thrsh_li.py Copyright (c) 2010-2025 Scott L. Williams released under GNU GPL V3.0'
...
class thrsh_li( operator ):
    ...
    def run( self ):                     # override superclass run
        ...
        t_li = skimage.filters.threshold_li( self.source )
        
        mask = self.source > t_li        # boolean mask
