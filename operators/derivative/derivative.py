...
@LICENSE
#
#  derivative.py Copyright (C) 2010-2026 Scott L. Williams.
# 
...
derivative_copyright = 'derivative.py Copyright (c) 2010-2026 Scott L. Williams, released under GNU GPL V3.0'
