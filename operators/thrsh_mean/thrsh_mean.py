...
@LICENSE
#
#  thrsh_mean.py Copyright (C) 2010-2025 Scott L. Williams.
# 
...
thrsh_mean_copyright = 'thrsh_mean.py Copyright (c) 2010-2025 Scott L. Williams, released under GNU GPL V3.0'
