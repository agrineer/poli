...
@LICENSE
#
#  thrsh_yen.py Copyright (C) 2010-2026 Scott L. Williams.
# 
...
thrsh_yen_copyright = 'thrsh_yen.py Copyright (c) 2010-2026 Scott L. Williams, released under GNU GPL V3.0'
